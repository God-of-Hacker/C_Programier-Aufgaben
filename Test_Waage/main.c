...
int main(void)
{
    ...
    while(1)
    {
        ...
        else if (!(eingangSpannung_mv > UNBEKANNT || (eingangSpannung_mv < START_LO) || (eingangSpannung_mv >= UNBEKANNT_LO) && (eingangSpannung_mv <= UNBEKANNT_HI) || (eingangSpannung_mv >= UNBEKANNT_1_LO) && (eingangSpannung_mv <= UNBEKANNT_1_HI) ))
        {
            rgbWrite(250,0,0);
